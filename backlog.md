# Bugs
1. Ignored readme doesn't  incorporate into skipped stats:
...
2. Tool hangs forever if the Git server stops responding:
...
# CRs
1. Super trivial change for Demo
...
2. README.md masks and file references can't be used together:
...
3. Handle locally deleted files that still exist in git:
...
# TechDept
1. Split test data into categories:
